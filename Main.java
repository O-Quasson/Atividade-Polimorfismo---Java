...
public class Main {
    public static void main(String[] args) {
        ...
        Desenvolvedor ponte2 = new Desenvolvedor(null, null, null, null, null, 0, 0, 0);
        Gerente ponte3 = new Gerente(null, null, null, null, null, 0, 0, 0);
        Estagiario ponte4 = new Estagiario(null, null, null, null, null, 0, 0, 0);

        while(esc!=5){
            System.out.println("Escolha uma das seguintes opções: ");
            System.out.println("1 - Cadastrar novos funcionários ");
            System.out.println("2 - Exibir funcionários cadastrados ");
            System.out.println("3 - Atribuir tipo diferente de funcionário ");
            ...
            switch(esc){
                case 1:
                    ...
                    if(id == 10){
                        ...
                        do{
                            System.out.println("Qual a posição de " + nome + "?");
                            ...
                            if((esc3>=1)&&(esc3<=3)){
                                if (esc3==1){
                                    funcionario[id] = new Desenvolvedor(nome, sobrenome, salario, departamento, cpf, dia, mes, ano);
                                }else if(esc2==2){
                                    funcionario[id] = new Gerente(nome, sobrenome, salario, departamento, cpf, dia, mes, ano);
                                }else if(esc3==3){
                                    funcionario[id] = new Estagiario(nome, sobrenome, salario, departamento, cpf, dia, mes, ano);
                                }
                            }else{
                                System.out.println("Posição inexistente. Tente denovo\n");
                            }
                        }while((esc3<1)||(esc3>3));
                ...
                case 3:
                    if(id>=1){
                        ...
                        if(funcionario[esc2-1]==null){
                            ...
                            if((esc3>0)&&(esc3<5)){
                                if (esc3==1){
                                    funcionario[id] = new Desenvolvedor(funcionario[esc2-1].getnome(), funcionario[esc2-1].getsobrenome(),funcionario[esc2-1].getsalario(), funcionario[esc2-1].getdepartamento(), funcionario[esc2-1].getcpf(), funcionario[esc2-1].getdia(), funcionario[esc2-1].getmes(), funcionario[esc2-1].getano());
                                }else if(esc2==2){
                                    funcionario[id] = new Gerente(funcionario[esc2-1].getnome(), funcionario[esc2-1].getsobrenome(),funcionario[esc2-1].getsalario(), funcionario[esc2-1].getdepartamento(), funcionario[esc2-1].getcpf(), funcionario[esc2-1].getdia(), funcionario[esc2-1].getmes(), funcionario[esc2-1].getano());
                                }else if(esc3==3){
                                    funcionario[id] = new Estagiario(funcionario[esc2-1].getnome(), funcionario[esc2-1].getsobrenome(),funcionario[esc2-1].getsalario(), funcionario[esc2-1].getdepartamento(), funcionario[esc2-1].getcpf(), funcionario[esc2-1].getdia(), funcionario[esc2-1].getmes(), funcionario[esc2-1].getano());
                                }
